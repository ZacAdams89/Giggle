...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func createPlaylistFromVideosInDocumentsDirectory() -> Playlist{
        ...
        if let videos = videoDataSource.loadVideosInBundle(){
...
extension AppDelegate: CoreDataStoreDelegate{
    ...
    func configureDataStore(_ dataStore: CoreDataStore, persistentStoreCoordinator: NSPersistentStoreCoordinator) {
        ...
        do {
            try persistentStoreCoordinator.addPersistentStore(ofType: NSInMemoryStoreType, configurationName:nil, at: dataStore.storeURL as URL, options: nil)
